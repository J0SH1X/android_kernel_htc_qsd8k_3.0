 ...
 * Author (C) 2017 Aljoshua Hell <aljoshua.hell@gmail.com>
 *
...
static struct capella_cm3602_platform_data capella_cm3602_pdata = {
	...
	.irq = MSM_GPIO_TO_INT(MAHIMAHI_GPIO_PROXIMITY_INT_N),
};
...
static struct htc_battery_platform_data htc_battery_pdev_data = {
	...
	.gpio_mbat_in = -1,
	.gpio_mchg_en_n = MAHIMAHI_GPIO_BATTERY_CHARGER_EN,
	.gpio_iset = MAHIMAHI_GPIO_BATTERY_CHARGER_CURRENT,
	.gpio_adp_9v = MAHIMAHI_GPIO_POWER_USB,
...
static struct msm_gpio misc_gpio_table[] = {
    { GPIO_CFG(MAHIMAHI_GPIO_LCD_RST_N, 0, GPIO_CFG_OUTPUT,
               GPIO_CFG_NO_PULL, GPIO_CFG_2MA)},
    { GPIO_CFG(MAHIMAHI_GPIO_LED_3V3_EN, 0, GPIO_CFG_OUTPUT,
               GPIO_CFG_NO_PULL, GPIO_CFG_2MA)},
    { GPIO_CFG(MAHIMAHI_GPIO_DOCK, 0, GPIO_CFG_OUTPUT,
               GPIO_CFG_NO_PULL, GPIO_CFG_4MA)},
};

static struct msm_gpio key_int_shutdown_gpio_table[] = {
    {GPIO_CFG(MAHIMAHI_GPIO_35MM_KEY_INT_SHUTDOWN, 0, GPIO_CFG_OUTPUT,
              GPIO_CFG_NO_PULL, GPIO_CFG_2MA)},
};
...
static void __init mahimahi_init(void)
{
	...
	pr_info("mahimahi_init() revision=%d\n", system_rev);
